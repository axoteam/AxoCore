...
This mechanism has been integrated into Bitcore-Node-Axo which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Axo-Project/insight-api-axo#web-socket-api](https://github.com/Axo-Project/insight-api-axo#web-socket-api) 
* API: [https://github.com/Axo-Project/insight-api-axo#swifttx-transactions](https://github.com/Axo-Project/insight-api-axo#swifttx-transactions) 
...
By default, the Axo Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Axo Core daemon:
