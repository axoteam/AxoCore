...
In order to support loading of multiple wallets in axo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is axo.cpp.
...
Changes to axo.cpp
----------------------
axo.cpp is the entry point into axo-qt, and as such, will require some minor modifications to provide hooks for
