...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Axo features */
        {"axo", "masternode", &masternode, true, true, false},
        {"axo", "listmasternodes", &listmasternodes, true, true, false},
        {"axo", "getmasternodecount", &getmasternodecount, true, true, false},
        {"axo", "masternodeconnect", &masternodeconnect, true, true, false},
        {"axo", "masternodecurrent", &masternodecurrent, true, true, false},
        {"axo", "masternodedebug", &masternodedebug, true, true, false},
        {"axo", "startmasternode", &startmasternode, true, true, false},
        {"axo", "createmasternodekey", &createmasternodekey, true, true, false},
        {"axo", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"axo", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"axo", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"axo", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"axo", "getmasternodescores", &getmasternodescores, true, true, false},
        {"axo", "mnbudget", &mnbudget, true, true, false},
        {"axo", "preparebudget", &preparebudget, true, true, false},
        {"axo", "submitbudget", &submitbudget, true, true, false},
        {"axo", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"axo", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"axo", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"axo", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"axo", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"axo", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"axo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"axo", "checkbudgets", &checkbudgets, true, true, false},
        {"axo", "mnsync", &mnsync, true, true, false},
        {"axo", "spork", &spork, true, true, false},
        {"axo", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"axo", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use axod, or the -server option to axo-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> axo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51471/\n";
}
