                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Axo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Axo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and axo: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Axo Core"), this);
    aboutAction->setStatusTip(tr("Show information about Axo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Axo"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Axo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Axo addresses"));
    ...
    openAction->setStatusTip(tr("Open a Axo: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Axo Core help message to get a list with possible Axo command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Axo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Axo network", "", count));
}
...
{
    QString strTitle = tr("Axo Core"); // default title
